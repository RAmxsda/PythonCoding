...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(
            text="Score: 0", fg="white", bg=THEME_COLOR, font=("Gameria", 20)
        )
        ...
        true_image = PhotoImage(
            file="/Python 100 days challenge/Day 31( API QuiZ)/images/right.png"
        )
        ...
        false_image = PhotoImage(
            file="/Python 100 days challenge/Day 31( API QuiZ)/images/wrong.png"
        )
